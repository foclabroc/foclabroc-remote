                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: (_recording || _loadingRecord)
                                  ? null
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                foregroundColor:
                                    _recording ? Colors.black : Colors.white38,
                                padding: const EdgeInsets.symmetric(vertical: 14),
                              ),
                            ),
                          ),
