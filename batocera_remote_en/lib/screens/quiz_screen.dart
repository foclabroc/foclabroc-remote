  ...
  void _startGame() {
    ...
    if (!state.isConnected) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Connect to Batocera first',
              ...
              child: Column(children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    const Text('Guess the game!',
                        style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w800)),
                    const SizedBox(height: 8),
                    const Text(
                      'A screenshot is shown,\nfind the game among 4 choices.',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      connected ? 'New game' : 'Not connected',
...
class _QuizGameScreenState extends State<_QuizGameScreen> {
      ...
      child: Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Add media via the Batocera scraper.',
              textAlign: TextAlign.center,
          ...
          if (!_answered)
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  'System: ${_correctGame['_systemFullname'] ?? _correctGame['_systemName'] ?? '?'}',
                  style: const TextStyle(color: Colors.white38, fontSize: 11),
                  textAlign: TextAlign.center,
                ),
              ),
  ...
  Widget _buildGameOver(Color accent) {
    ...
    final msg = pct >= 90 ? 'Screenshot expert!' : pct >= 70 ? 'Quite the connoisseur!' : pct >= 50 ? 'Not bad at all!' : 'You need to play more... 😅';
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Text('$pct% correct answers', style: TextStyle(color: scoreColor.withOpacity(0.7), fontSize: 13)),
              ]),
            ),
            ...
            Row(children: [
              _StatCard(label: 'Correct\nanswers', value: '$correct/$_totalQuestions', color: Colors.greenAccent, icon: Icons.check_rounded),
              const SizedBox(width: 10),
              _StatCard(label: 'Best\nstreak', value: 'x$_bestStreak', color: Colors.orangeAccent, icon: Icons.local_fire_department_rounded),
              const SizedBox(width: 10),
              _StatCard(label: 'Total\nscore', value: '$_score', color: accent, icon: Icons.star_rounded),
            ]),
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('SUMMARY', style: TextStyle(color: Colors.white38, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1)),
                const SizedBox(height: 12),
