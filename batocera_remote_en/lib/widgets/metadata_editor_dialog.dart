                    ...
                    children: [
                      if (extras.isNotEmpty)
                        Padding(
                          ...
                          child: Text(
                            'Custom genres preserved: ${extras.join(", ")}',
                    ...
                    children: [
                      if (extras.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.fromLTRB(8, 4, 8, 8),
                          child: Text(
                            'Custom codes preserved: ${extras.join(", ")}',
                            style: const TextStyle(
                                color: Colors.white38, fontSize: 11),
                          ),
                        ),
                    ...
                    children: [
                      if (extraCode.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.fromLTRB(8, 4, 8, 8),
                          child: Text(
                            'Custom code preserved: $extraCode'
                            ' (will be replaced if you pick below)',
                            style: const TextStyle(
                                color: Colors.white38, fontSize: 11),
                          ),
                        ),
            ...
            children: [
              ...
              _field('Genre', _genre,
                suffixIcon: IconButton(
                  ...
                  tooltip: 'Standard genres',
                  onPressed: _openGenrePicker,
                  visualDensity: VisualDensity.compact,
                  splashRadius: 20,
                ),
              ),
              _field('Developer', _developer),
              _field('Publisher', _publisher),
              _field('Players', _players, keyboardType: TextInputType.number),
              _field('Language(s)', _lang,
                suffixIcon: IconButton(
                  icon: const Icon(Icons.arrow_drop_down_rounded,
                      color: Colors.white54),
                  tooltip: 'Pick languages',
